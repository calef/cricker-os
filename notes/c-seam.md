...
Milestone 36, DECISIONS §30. Built 2026-07-29, both ISAs, in QEMU.
...
- **The libc list is this component's list.** A component wanting `errno`, `assert`, `stdio`, locales,
  ...
  (`stdio`, TLS) are tier-three questions wearing a tier-two coat. The rule from DECISIONS §30 stands:
