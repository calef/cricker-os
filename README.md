...
| `script/verify` | 124 Kani harnesses <!--count:kani-harnesses--> across 22 crates <!--count:harness-crates-->: the capability model, IPC, MMU isolation, the DMA validator, the IOMMU domain, the NTP era pivot. |
