...
| `script/verify` | 121 Kani harnesses <!--count:kani-harnesses--> across 21 crates <!--count:harness-crates-->: the capability model, IPC, MMU isolation, the DMA validator, the IOMMU domain, the NTP era pivot. |
