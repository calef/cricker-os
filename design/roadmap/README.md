...
| 97 | IN-PROGRESS | [Citations that name what they cite](97-citations-that-name.md) | 23 sites cite "milestone 24" meaning DECISIONS §24, wrong at birth (the roadmap said Virtualization.framework on the day the first was written) and spread by copy-paste. Neither gate can see it, because both numbers resolve. The durable half is a lint that checks a citation's parenthetical name against the real title | |
