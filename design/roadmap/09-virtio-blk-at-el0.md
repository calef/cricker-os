...
- `7a10c7b` **9**: "a driver at EL0 read the file 'motd' off a virtio disk, through a crickerfs
...
milestone. The driver parsed crickerfs itself, and a filesystem behind its own capability server
